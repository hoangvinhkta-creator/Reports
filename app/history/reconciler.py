...
INSERT / SAME / SOURCE_CHANGED / ORDER_KEY_COLLISION. Bước 4
(``NOT_SEEN_IN_LATEST_SNAPSHOT``) và bước R (``REMOVED_IN_SOURCE_CANDIDATE``)
thuộc slice B và CỐ Ý chưa có ở đây — chúng cần coverage
``CONFIRMED_COMPLETE``, thứ mà slice A không có đường nào tạo ra.
"""
...
from app.history.models import (
    COLLISION_DAY_THRESHOLD, CurrentState, Decision, LineKey, OUTCOME_COLLISION,
    OUTCOME_INSERT, OUTCOME_SAME, OUTCOME_SOURCE_CHANGED, ReconcileResult, SourceLine,
)

...
| 17 | Product / Transaction Classification | `03` — bảng phân loại; DEC-110, DEC-113 | TASK-103 | PHÂN TÍCH XONG |
| 18 | **Data Validation & Review Queue (5 loại)** | **Bổ sung 5 loại cảnh báo vào TASK-110** | TASK-110 | ĐÃ GHI NHẬN |
| 19 | Manual Override & Audit Trail (8 field) | `03` §M; `ADR-102` | TASK-202 | PHÂN TÍCH XONG |
| 20 | **Price Master (8 field)** | **Bổ sung schema vào TASK-401**; DEC-103 | TASK-401 | ĐÃ GHI NHẬN |
| 21 | Target và Commission | `04` §3–4 — bảng target và tỉ lệ thưởng thật; DEC-116 | TASK-403 | PHÂN TÍCH XONG |
| 22 | Import workflow (15 bước) | **Bổ sung 15 bước vào TASK-101** | TASK-101…112 | ĐÃ GHI NHẬN |
| 23 | **Export Excel (5 loại sheet)** | **Bổ sung danh sách sheet vào TASK-111**; DEC-115 | TASK-111 | ĐÃ GHI NHẬN |
| 24 | Kiến trúc code (13 module) | `ADR-101` — 9 module gộp từ 13 engine | Cả Phase 1 | PHÂN TÍCH XONG |
| 25 | Công nghệ đề xuất | `ADR-101` — chọn FastAPI + React thay Streamlit, có lý do | Cả 4 phase | PHÂN TÍCH XONG |
...
| File thô **không có giá nhập**, chỉ có lợi nhuận ERP | `01` §3 | RISK-03, DEC-103 |

# PROJECT DECISIONS — Audit Track (S001–S007)

> Di dời từ `PROJECT/PROJECT_DECISIONS.md` khi merge PR#4 (2026-08-23). Sau khi
> merge nhánh audit (S001–S007) với nhánh dự án Tín Phát, cả hai đều có
> `PROJECT_DECISIONS.md` riêng đánh số trùng DEC-001..016. `PROJECT/PROJECT_DECISIONS.md`
> giữ lại cho dự án Tín Phát (đang hoạt động); nội dung gốc của track audit
> được chuyển nguyên văn — không chỉnh sửa — về đây để giữ nguyên vẹn các
> DEC-XXX mà `docs/audit/`, `docs/sessions/`, `docs/tasks/TASK-REM-*.md` và
> `governance/scripts/governance/README.md` đang trích dẫn.
